...
function setDelay(difficulty) {
  return 1000; // TODO: Write your code here.
}
...
function showAndHide(mole, delay) {
  toggleVisibility(mole); // TODO: call the toggleVisibility function so that it adds the 'show' class.
...
const audioHit = new Audio(
  "https://cdn.pixabay.com/download/audio/2022/01/08/audio_a7e697f7e7.mp3?filename=coconut-grove-bongo-drum-kit-solo-by-prettysleepy-art-13825.mp3"
);
